...
> 更新日期：2026-09-18 · 版本 **v3.17.0**（v3.17.0 国际计算批次化四项体验：导出文件名批次前缀 / 恢复订单
...
## 当前状态速览（2026-09-18 v3.17.0 后）

- **代码层**：v3.17.0 功能轮；vitest 全套 **464 例全绿**，aoi-qqbot node:test **68 例全绿**。前端两通道
