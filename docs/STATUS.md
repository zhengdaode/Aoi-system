...
> 更新日期：2026-09-18 · 版本 **v3.17.1**（v3.17.1 每人应付国际费「购买内容」列宽随视口自适应换行；
...
## 当前状态速览（2026-09-18 v3.17.1 后）

- **代码层**：v3.17.1 功能轮；vitest 全套 **465 例全绿**，aoi-qqbot node:test **68 例全绿**。前端两通道
